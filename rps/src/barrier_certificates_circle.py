...
si_barrier_cert = create_single_integrator_barrier_certificate(barrier_gain=10)
si_barrier_cert2 = create_single_integrator_barrier_certificate_ellipse(barrier_gain=1,safety_a=0.3,safety_b=0.2)
